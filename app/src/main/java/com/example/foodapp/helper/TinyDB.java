...
public class TinyDB {
    ...
    public void putListObject(String key, ArrayList<Foods> playerList){
        ...
        checkForNullKey(key);/// Verifica que la clave no sea nula
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();

        // Convierte cada objeto Foods a su representación en formato JSON
        for(Foods player: playerList){
            objStrings.add(gson.toJson(player));
        }

        // Almacena la lista de objetos en SharedPreferences como una lista de cadenas JSON
